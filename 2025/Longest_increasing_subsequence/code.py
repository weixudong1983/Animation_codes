...
class LISVisualization(Scene):
    def construct(self):
        ...
        self.play(
            *[ShowCreation(square) for square in nums_squares],
            *[ShowCreation(square) for square in dp_squares]
        )
        ...
        self.play(
            ShowCreation(explanation_box),
            Write(explanation),
            ShowCreation(i_group),
            ShowCreation(j_group)
        )
        ...
        for i in range(n):
            ...
            self.play(
                ShowCreation(nums_highlight),
                ShowCreation(dp_highlight)
            )
            ...
            for j in range(i):
                ...
                self.play(
                    ShowCreation(j_nums_highlight),
                    ShowCreation(j_dp_highlight)
                )
        ...
        self.play(*[ShowCreation(h) for h in max_highlights])
        ...
        self.play(*[ShowCreation(h) for h in lis_highlights])
